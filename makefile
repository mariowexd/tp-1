...
Tp1: tp1.o mod.o ej3.o ej4_5.o main.o 
	gcc -Wall -std=c99 -pedantic -g tp1.o mod.o ej3.o ej4_5.o main.o -o Tp1 -lm

tp1.o: ej3.h tp1.h ej4_5.h mod.h
...
main.o: ej3.h tp1.h ej4_5.h mod.h
