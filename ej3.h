...
void muestrear_armonicos(float[], size_t, double, int, float, float, const float [][2], size_t);
tramo_t *tramo_crear_muestreo(double, double, int, float, float, const float [][2], size_t);
